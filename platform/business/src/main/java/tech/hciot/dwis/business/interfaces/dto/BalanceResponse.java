...
import tech.hciot.dwis.business.domain.model.OnePointDoubleSerialize;
...
public class BalanceResponse {
  ...
  @JsonSerialize(using = OnePointDoubleSerialize.class)
  ...
  @Builder.Default
  private boolean tip_BNSF = false; // CJ33车轮需要根据化学元素是否弹出“BNSF不发运”
  @Builder.Default
  private boolean tip_exterior_insp = false; //CJ33车轮需要根据化学元素是否弹出“单独作外观检查”
  @Builder.Default
  private boolean tip_NG = false; //判断是否弹出“不打磨车轮”
  @Builder.Default
  private boolean tip_RoundnessCheck = false; //判断是否弹出“圆度复检”
