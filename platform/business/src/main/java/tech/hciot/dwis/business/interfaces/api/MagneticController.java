...
import tech.hciot.dwis.business.application.MagneticService;
...
public class MagneticController {
  ...
  @ApiOperation(value = "查询磁探记录列表")
  @PreAuthorize("isAuthenticated()")
  public PageDataResponse<MagneticRecord> find(
    ...
    Page<MagneticRecord> page = magneticService.find(wheelSerial, reworkCode, scrapCode,
  ...
  public MagneticResponse findWheel(@PathVariable String wheelSerial) {
    return magneticService.findWheel(wheelSerial);
  }

  @PostMapping(value = "", consumes = MediaType.APPLICATION_JSON_VALUE)
  @ApiOperation(value = "添加磁探记录")
  @Log(name = "添加磁探记录", type = OperationType.OPERATION_TYPE_ADD)
  @PreAuthorize("isAuthenticated()")
  public Integer add(@Validated @RequestBody @Request MagneticRecord request) {
    return magneticService.add(request);
  }
}
