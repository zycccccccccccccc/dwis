...
import tech.hciot.dwis.business.application.SmCenterRemoteService;
...
public class TokenScheduledTask {
  ...
  @Autowired
  private SmCenterRemoteService tokenRemoteService;
  ...
  public String getToken() {
    ...
    try {
      jsonObject = tokenRemoteService.getToken(params);
    } catch (Exception e) {
