...
SELECT
  ...
  dbo.percentage(scrap_sum, (to_dock + scrap_sum)) AS scrap_dock_and_scrap,
  dbo.percentage(to_dock, (to_dock + scrap_sum)) AS to_dock_dock_and_scrap
FROM (
SELECT
  *
FROM stat
